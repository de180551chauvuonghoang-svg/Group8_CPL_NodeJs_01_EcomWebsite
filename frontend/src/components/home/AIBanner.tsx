        ...
        <div className="relative z-10 flex flex-col md:flex-row gap-12 items-center justify-between">
          <div className="flex-1 max-w-2xl text-white">
            ...
            <p className="text-lg text-white/90 mb-8 max-w-xl leading-relaxed">
              Bạn chỉ cần mô tả nhu cầu bằng ngôn ngữ tự nhiên. Chuyên gia AI của chúng tôi sẽ tự
              động phân tích và chọn lọc các sản phẩm phù hợp nhất với phong cách và ngân sách của
              bạn.
            </p>

            <form
              onSubmit={handleAISearch}
              className="relative flex items-center max-w-xl group/form"
            >
              <input
                type="text"
                value={query}
              ...
              >
                ...
                <ArrowRight
                  size={20}
                  className="group-focus-within/form:translate-x-1 transition-transform"
                />
              </button>
            </form>
          </div>
